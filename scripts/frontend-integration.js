 ...
 * This file demonstrates how to integrate Lynxjolt with a web frontend
 */

// For React/Vue/Angular applications
export class LynxjoltClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new LynxjoltClient(provider, contractAddress);
